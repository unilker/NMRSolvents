...
| **Kayıtlar** | Pik aramasının sonucu "Sonuçları kaydet" ile numune adı, analiz tarihi ve isteğe bağlı notla kaydedilir; spektrumda tanımlanan safsızlıklar işaretlenir. Kayıtlar analiz tarihine göre listelenir, numune adı veya notla aranır; ayrıntıdan düzenlenebilir, silinebilir veya metin olarak kopyalanabilir. Kayıtlar yalnızca cihazda saklanır. |
| **Ayarlar** | Dil (cihaz/Türkçe/English), 6 renk teması, açık/koyu/sistem görünümü. *Uygulama hakkında*: geliştirici, uygulama hakkında, özellikler, veri içeriği ve hazırlanışı, önemli not, numaralı kaynakça |
